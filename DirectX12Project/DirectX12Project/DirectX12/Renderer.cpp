...
void Renderer::CreateRootSignature(ID3D12Device& dev)
{
	...
	samplerDesc[2].Filter = D3D12_FILTER_COMPARISON_MIN_MAG_MIP_LINEAR;// 比較リニア補間
...
bool Renderer::CreatePipelineState(ID3D12Device& dev)
{
	...
	plsDesc.BlendState.RenderTarget[0].BlendEnable = true;
	...
	plsDesc.BlendState.RenderTarget[0].SrcBlendAlpha = D3D12_BLEND_SRC_ALPHA;
